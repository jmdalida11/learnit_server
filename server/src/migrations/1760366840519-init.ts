...
export class Init1760366840519 implements MigrationInterface {
    name = 'Init1760366840519'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "question" ("id" varchar PRIMARY KEY NOT NULL, "questionText" text NOT NULL, "options" text, "correctAnswer" text, "type" text NOT NULL DEFAULT ('multiple_choice'), "quizId" varchar)`);
        await queryRunner.query(`CREATE TABLE "quiz" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar(255) NOT NULL, "attempts" integer NOT NULL DEFAULT (0), "averageScore" decimal NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, "noteId" varchar)`);
        await queryRunner.query(`CREATE TABLE "note" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar(255) NOT NULL, "content" text NOT NULL, "tags" text, "isShared" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar)`);
        await queryRunner.query(`CREATE TABLE "study_plan" ("id" varchar PRIMARY KEY NOT NULL, "subject" varchar(255) NOT NULL, "description" text, "scheduledDate" date NOT NULL, "completed" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar)`);
        await queryRunner.query(`CREATE TABLE "notification" ("id" varchar PRIMARY KEY NOT NULL, "message" text NOT NULL, "read" boolean NOT NULL DEFAULT (0), "scheduledFor" datetime NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_question" ("id" varchar PRIMARY KEY NOT NULL, "questionText" text NOT NULL, "options" text, "correctAnswer" text, "type" text NOT NULL DEFAULT ('multiple_choice'), "quizId" varchar, CONSTRAINT "FK_4959a4225f25d923111e54c7cd2" FOREIGN KEY ("quizId") REFERENCES "quiz" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_quiz" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar(255) NOT NULL, "attempts" integer NOT NULL DEFAULT (0), "averageScore" decimal NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, "noteId" varchar, CONSTRAINT "FK_52c158a608620611799fd63a927" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_11aa3bf1a8de83e63f73317013b" FOREIGN KEY ("noteId") REFERENCES "note" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_note" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar(255) NOT NULL, "content" text NOT NULL, "tags" text, "isShared" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, CONSTRAINT "FK_5b87d9d19127bd5d92026017a7b" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_study_plan" ("id" varchar PRIMARY KEY NOT NULL, "subject" varchar(255) NOT NULL, "description" text, "scheduledDate" date NOT NULL, "completed" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, CONSTRAINT "FK_205af0c7adc562c681843fc6071" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_notification" ("id" varchar PRIMARY KEY NOT NULL, "message" text NOT NULL, "read" boolean NOT NULL DEFAULT (0), "scheduledFor" datetime NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, CONSTRAINT "FK_1ced25315eb974b73391fb1c81b" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
